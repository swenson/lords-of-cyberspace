...
let cp437_to_unicode = function(inp) {
  let s = '';
  for (let i = 0; i < inp.length; i++) {
    s += String.fromCodePoint(num_mapping[inp[i]]);
  }
  return s;
};

module.exports = cp437_to_unicode;


/*

From https://www.unicode.org/Public/MAPPINGS/VENDORS/MICSFT/PC/CP437.TXT
Thanks Shawn Steele.
